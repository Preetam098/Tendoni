...
const notHiredPage = () => {
  return (
    <>
      ...
      >
        <div>
          <h2>Not Hired Candidate</h2>
        </div>
      </div>
      <>
        <RecruitmentView />
      </>
      <PageContainer title="Not Hired" description="Not Hired">
        <Box flexGrow={1}>
          <Grid container spacing={3}>
            <Grid item xs={12} lg={12}>
              <Grid container spacing={3}>
                <Grid item xs={12} lg={12}>
                  <DashboardCard title="Not Hired Candidate">
                    <TableContainer>
                      <Table>
                        <TableHead>
                          <TableRow>
                        ...
                        <TableBody>
                          {[
                            ...
                            <TableRow key={index}>
                              ...
                              <TableCell>{row.reasone}</TableCell>
